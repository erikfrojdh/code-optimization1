...
public:
  ...
  */
  ...
  {
    // without dhc       if (fwrite((void*)this, 4*sizeof(int)+4*sizeof(int16_t)+4*sizeof(double)+sizeof(quad), 1, myFile))

    if (fwrite((void *)this, 4 * sizeof(int) + 3 * sizeof(int16_t) + sizeof(int32_t) + 4 * sizeof(double) + sizeof(quad), 1, myFile))
  ...
  */
  ...
  {
    // without dhc    if (fread((void*)this, 4*sizeof(int)+4*sizeof(int16_t)+4*sizeof(double)+sizeof(quad), 1, myFile)) //changed/swapped position of XXX, 1,

    if (fread((void *)this, 4 * sizeof(int) + 3 * sizeof(int16_t) + sizeof(int32_t) + 4 * sizeof(double) + sizeof(quad), 1, myFile)) //changed/swapped position of XXX, 1,
